...
// typst::layout::Position no longer exists; removed the re-export

use serde::{Deserialize, Serialize};

/// A serializable physical position in a document.
///
/// Note that it uses [`f32`] instead of [`f64`] for the coordinates to
/// improve both performance of serialization and calculation.
