...
impl<D: typst::model::Document + Send + Sync + 'static + typst::foundations::Output> CompilationTask<D> {
...
impl<D> OptionDocumentTask<D> where D: typst::model::Document + Send + Sync + 'static + typst::foundations::Output {}
...
impl<F: CompilerFeat> WorldComputeGraph<F> {
    ...
    pub fn pure_compile<D: ::typst::model::Document + Send + Sync + 'static + typst::foundations::Output>(
        &self,
