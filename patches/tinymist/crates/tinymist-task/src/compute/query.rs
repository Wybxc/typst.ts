...
use typst::foundations::{Content, Context, IntoValue, LocatableSelector, Scope, Value};
...
impl DocumentQuery {
    ...
    pub fn retrieve<D: typst::model::Document + typst::foundations::Output>(
        world: &dyn World,
        selector: &str,
        document: &D,
    ...
    fn run_inner<F: CompilerFeat, D: typst::model::Document + typst::foundations::Output>(
    ...
    /// Queries the document and returns the result as a value.
    pub fn get_as_value<F: CompilerFeat, D: typst::model::Document + typst::foundations::Output>(
        g: &Arc<WorldComputeGraph<F>>,
        doc: &Arc<D>,
        config: &QueryTask,
    ) -> Result<serde_json::Value> {
...
impl<F: CompilerFeat, D: typst::model::Document + typst::foundations::Output> ExportComputation<F, D> for DocumentQuery {
