import type { CompileArgs, NodeHtmlOutputExecResult } from '@wybxc/typst-ts-node-compiler';
...
interface Providers {
  ...
  '@wybxc/typst-ts-node-compiler': NodeCompileProvider;
}
...
export interface TypstPluginOptions<K extends ProviderKind | CompileProviderConstructor | undefined>
   ...
   * @default '@wybxc/typst-ts-node-compiler'
   */
...
async function createCompiler<K extends ProviderKind | CompileProviderConstructor | undefined>(
  ...
  let TCompileProvider = (
    options.compiler === undefined || options.compiler === '@wybxc/typst-ts-node-compiler'
